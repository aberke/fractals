 ...
 **/
	function getNextPoint(fromPoint, distance, angle) {
		if (angle > RADIANS_360_DEGREES || angle < -1 * RADIANS_360_DEGREES) return;
	...
	return {
		...
		PURPLE: PURPLE,
		RADIANS_45_DEGREES: RADIANS_45_DEGREES,
		RADIANS_60_DEGREES: RADIANS_60_DEGREES,
		RADIANS_90_DEGREES: RADIANS_90_DEGREES,
		RADIANS_360_DEGREES: RADIANS_360_DEGREES,

		getCanvasCenterPoint: getCanvasCenterPoint,
		addLine: addLine,
		getNextPoint: getNextPoint,
		getTriangleHeight: getTriangleHeight,
		drawPathByPath: drawPathByPath,
		rotatePoint: rotatePoint,
		drawFractalRow: drawFractalRow
	};
}();